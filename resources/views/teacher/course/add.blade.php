                ...
                <div class="card-body">
                    ...
                    <form action="{{route('course.new')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="date" name="start_date" class="form-control" id="horizontal-email-input">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-password-input" class="col-sm-3 col-form-label">Ending Date</label>
                            <div class="col-sm-9">
                                <input type="date" name="end_date" class="form-control" id="horizontal-password-input">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="fee" class="form-control" id="horizontal-password-input1">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <textarea name="short_description" class="form-control" id="horizontal-password-input4"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <textarea name="long_description" class="form-control summernote" id="horizontal-password-input2"></textarea>
                            </div>
                        </div>
